...
pub async fn register_adapter(
    ...
    let client = reqwest::Client::builder()
        ...
        .build()
        .map_err(|e| SynapseError::BackendError(format!("HTTP client error: {e}")))?;
    ...
    let resp = client
        ...
        .send()
        .await
        .map_err(|e| SynapseError::BackendError(format!("Ollama create failed: {e}")))?;
    ...
    if resp.status().is_success() {
        ...
        Err(SynapseError::BackendError(format!(
