...
<div class="settings-page">
  ...
  <section>
    ...
    <div class="card">
      ...
      {:else}
        <p style="color: var(--text-secondary)">Not connected. Make sure <code>synapse serve</code> is running.</p>
      {/if}
    </div>
  ...
  <section>
    ...
    <div class="card">
      <p style="color: var(--text-secondary)">
        Edit <code>~/.synapse/synapse.toml</code> to configure backends, storage paths, and training settings.
      </p>
    </div>
  </section>
</div>
