...
use ifran_bridge::server::BridgeServer;
use ifran_core::config::IfranConfig;
use ifran_core::eval::runner::EvalRunner;
use ifran_core::experiment::store::ExperimentStore;
use ifran_core::fleet::manager::FleetManager;
use ifran_core::hardware::events::GpuEventBus;
use ifran_core::hardware::telemetry::{TelemetryConfig, TelemetryLoop};
use ifran_core::lifecycle::manager::ModelManager;
use ifran_core::lineage::store::LineageStore;
use ifran_core::marketplace::catalog::MarketplaceCatalog;
use ifran_core::rag::store::RagStore;
use ifran_core::rlhf::store::AnnotationStore;
use ifran_core::storage::db::ModelDatabase;
use ifran_core::tenant::store::TenantStore;
use ifran_core::training_events::TrainingEventBus;
use ifran_core::versioning::store::VersionStore;
use ifran_train::dataset::labeler::AutoLabeler;
use ifran_train::distributed::coordinator::DistributedCoordinator;
use ifran_train::executor::ExecutorKind;
use ifran_train::experiment::runner::ExperimentHandle;
...
impl AppState {
    ...
    pub fn new(config: IfranConfig) -> ifran_types::error::Result<Self> {
