...
use crate::bridge::protocol::{ConnectionState, Heartbeat, ProtocolConfig};
use crate::lifecycle::manager::ModelManager;
use crate::train::job::manager::JobManager;
use crate::types::TenantId;
use crate::types::bridge::ifran_bridge_server::{IfranBridge, IfranBridgeServer};
...
use crate::types::training::TrainingJobConfig;
use std::pin::Pin;
use std::sync::Arc;
...
impl BridgeServer {
    ...
    pub async fn start(
        ...
        *self.state.write().await = ConnectionState::Connecting;
        ...
        let addr = bind_addr
            .parse()
            .map_err(|e| crate::types::IfranError::BridgeError(format!("Invalid address: {e}")))?;
...
impl IfranBridge for IfranBridgeService {
    ...
    async fn run_inference(
        ...
        let inference_req = crate::types::inference::InferenceRequest {
            prompt: req.prompt,
