        ...
        tokio::spawn(async move {
            ...
            let infer_fn = |prompt: String| {
                ...
                async move {
                    ...
                    let backend_id =
                        crate::types::backend::BackendId(loaded_model.backend_id.clone());
...
fn run_to_response(run: &crate::eval::runner::EvalRunState) -> EvalRunResponse {
    EvalRunResponse {
        run_id: run.run_id,
...
mod tests {
    use super::*;
    use crate::eval::runner::EvalRunState;
