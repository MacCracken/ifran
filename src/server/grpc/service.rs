...
use crate::types::ifran_proto::ifran_service_server::IfranService;
use crate::types::ifran_proto::{
...
impl IfranService for IfranGrpcService {
    ...
    async fn get_status(
        ...
        let gpus = crate::hardware::detect::detect()
            .map(|hw| {
                hw.gpus
                    .iter()
                    .map(|g| GpuInfo {
    ...
    async fn list_models(
        ...
        let paged = self
            .state
            .db
            .list(&crate::types::TenantId::default_tenant(), 1000, 0)
