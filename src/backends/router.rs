...
use crate::types::backend::{BackendId, BackendLocality};
use crate::types::inference::DataSensitivity;
...
mod tests {
    ...
    impl InferenceBackend for MockBackend {
        ...
        async fn load_model(
            ...
            _: &ModelManifest,
            _: &DeviceConfig,
        ) -> crate::types::error::Result<crate::backends::ModelHandle> {
            Ok(crate::backends::ModelHandle("mock".into()))
        }
        async fn unload_model(
            &self,
            _: crate::backends::ModelHandle,
